    ...
    public static void main(String[] args) {
        try {
            ...
            if (rs.next()) {
                ...
                System.out.println("Mật khẩu: " + matKhau.substring(0, Math.min(30, matKhau.length())) + "...");
                System.out.println("Độ dài: " + matKhau.length());
                
                // Kiểm tra BCrypt
                if (matKhau.startsWith("$2a$") || matKhau.startsWith("$2b$")) {
                    System.out.println("\n✅ Mật khẩu đã được hash bằng BCrypt!");
                    System.out.println("✅ Login với admin/admin123 sẽ hoạt động!");
                } else {
                    System.out.println("\n❌ Mật khẩu vẫn là plain text: " + matKhau);
                }
            } else {
